    ...
    Tables: {
      ...
      cognitive_assessments: {
        Row: {
          ...
          pattern_avg_time_ms: number | null
          pattern_total_trials: number | null
          reaction_accuracy: number | null
          reaction_avg_time_ms: number | null
          impulse_errors: number | null
          attention_consistency: number | null
          visual_preference_score: number | null
          auditory_preference_score: number | null
          interaction_intensity: number | null
          raw_telemetry: Json | null
          profile_visual: number | null
          profile_auditory: number | null
          profile_movement: number | null
          profile_logic: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "cognitive_assessments_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      growth_plans: {
        Row: {
          ...
          directions: Json
          milestones: Json
          recommended_partners: string[] | null
          status: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "growth_plans_assessment_id_fkey"
            columns: ["assessment_id"]
            isOneToOne: false
            referencedRelation: "cognitive_assessments"
            referencedColumns: ["id"]
          },
          {
