                ...
                <aside className="lg:col-span-3 space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        {submittedVideos.map((video) => (
                            <div
                                key={video.id}
                                className="flex items-start gap-3 p-3 bg-white dark:bg-[#1a2e2c] rounded-xl border border-gray-200 dark:border-gray-700 hover:border-[#00695C]/50 transition-colors cursor-pointer group shadow-sm"
                            >
