                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <Card className="border-none shadow-sm bg-white rounded-3xl overflow-hidden">
                        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <Button variant="ghost" size="sm" className="text-slate-500 font-bold">Xem tất cả</Button>
                        </div>
                        <div className="p-2">
                            {[
                        ...
                        <div className="divide-y divide-slate-100">
                            {[
                                ...
                                <div key={i} className="p-4 hover:bg-slate-50 transition-colors flex items-center justify-between group">
                                    ...
                                    <Button className="bg-white border-2 border-slate-100 hover:border-[#00695C] hover:text-[#00695C] text-slate-600 font-bold rounded-xl shadow-sm">
                                        Review ngay
                                    </Button>
                                </div>
                            ))}
                    ...
                    <Card className="border-none shadow-sm bg-gradient-to-br from-[#00695C] to-[#004D40] rounded-3xl overflow-hidden text-white">
                        <div className="p-6">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <Button variant="secondary" className="col-span-2 h-auto py-3 flex items-center justify-center gap-2 bg-white text-[#00695C] hover:bg-slate-100 border-none font-bold">
